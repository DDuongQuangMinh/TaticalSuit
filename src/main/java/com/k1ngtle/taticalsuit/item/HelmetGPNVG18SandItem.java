...
import com.k1ngtle.taticalsuit.client.model.HelmetGPNVG18SandModel;
import com.k1ngtle.taticalsuit.client.renderer.HelmetGPNVG18SandRenderer;
...
public class HelmetGPNVG18SandItem extends ArmorItem implements GeoItem {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            ...
            private GeoItemRenderer<HelmetGPNVG18SandItem> itemRenderer;
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (this.itemRenderer == null) {
                    this.itemRenderer = new GeoItemRenderer<>(new HelmetGPNVG18SandModel());
                }
    ...
    private PlayState predicate(AnimationState<HelmetGPNVG18SandItem> state) {
