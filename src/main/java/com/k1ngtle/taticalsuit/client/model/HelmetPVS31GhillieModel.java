...
public class HelmetPVS31GhillieModel extends DefaultedItemGeoModel<HelmetPVS31GhillieItem> {
    public HelmetPVS31GhillieModel() {
        super(new ResourceLocation(TaticalSuit.MODID, "helmet_pvs31_ghillie"));
    }
