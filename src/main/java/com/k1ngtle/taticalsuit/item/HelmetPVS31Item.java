...
import com.k1ngtle.taticalsuit.client.renderer.HelmetPVS31Renderer;
...
public class HelmetPVS31Item extends ArmorItem implements GeoItem {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            ...
            private GeoItemRenderer<HelmetPVS31Item> itemRenderer;
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (this.itemRenderer == null) {
                    this.itemRenderer = new GeoItemRenderer<>(new HelmetPVS31Model());
                }
    ...
    private PlayState predicate(AnimationState<HelmetPVS31Item> state) {
        ItemStack stack = state.getData(DataTickets.ITEMSTACK);
        
        if (stack != null) {
            CompoundTag tag = stack.getOrCreateTag();
            // Check if the NVG is toggled ON or OFF
