...
import com.k1ngtle.taticalsuit.client.model.HelmetGPNVG18SnowModel;
import com.k1ngtle.taticalsuit.client.renderer.HelmetGPNVG18SnowRenderer;
...
public class HelmetGPNVG18SnowItem extends ArmorItem implements GeoItem {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            ...
            private GeoItemRenderer<HelmetGPNVG18SnowItem> itemRenderer;
            ...
            public BlockEntityWithoutLevelRenderer getCustomRenderer() {
                if (this.itemRenderer == null) {
                    this.itemRenderer = new GeoItemRenderer<>(new HelmetGPNVG18SnowModel());
                }
    ...
    private PlayState predicate(AnimationState<HelmetGPNVG18SnowItem> state) {
